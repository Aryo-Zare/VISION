...
plt.suptitle( 'Roaming behavior of animal in the open-field' 
...
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\roam_pooled.pdf' )
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\roam_pooled.svg' )
