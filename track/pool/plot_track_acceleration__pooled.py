...
plt.suptitle( 'Positive & negative acceleration in open-field' 
...
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\acceleration_pooled.pdf' )
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\acceleration_pooled.svg' )
