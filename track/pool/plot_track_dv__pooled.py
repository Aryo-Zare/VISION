...
plt.suptitle( 'Velocity and distance walked in the open-field' 
...
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\dv_pooled.pdf' )
plt.savefig( r'F:\OneDrive - Uniklinik RWTH Aachen\vision\track\pool\plot\dv_pooled.svg' )
